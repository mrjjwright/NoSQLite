(function(){
            ...
            for (_h = 0, _j = _i.length; _h < _j; _h++) {
              ...
              _g.push((function() {
                ...
                return transaction.executeSql(insert_sql.index_placeholder, insert_sql.bindings, function(transaction, srs) {
                  var _k, _l, _m, _n, _o, _p, _q, child_desc, child_obj;
                  ...
                  if ((typeof (_q = current_obj_desc.children) !== "undefined" && _q !== null) && current_obj_desc.children.length > 0) {
  ...
  NSLCore.prototype.execute = function(sql, callback) {
    return this.db.transaction(function(transaction) {
      return transaction.executeSql(sql, null, function(transaction, srs) {
        if ((typeof callback !== "undefined" && callback !== null)) {
