(function(){
  var NoSQLite, _a, nosqlite, nsl_console, nsl_debug, nsl_sync, sys, webdb_provider;
  ...
  // Add save hooks
  NoSQLite.prototype.onSave = function(hook) {
    if ((typeof hook !== "undefined" && hook !== null)) {
      return this.saveHooks.push(hook);
    }
  };
  //# Core Methods #################################
  ...
  NoSQLite.prototype.save = function(obj_desc, save_hook, callback) {
    var current_err, current_obj_desc, db, obj_descs, res, save_args, self;
    if (_.isArray(obj_desc)) {
      obj_descs = obj_desc;
    }
    if (!_.isArray(obj_desc)) {
      obj_descs = [obj_desc];
    ...
    return db.transaction(function(transaction) {
      ...
      insert_objs = function(obj_descs, hook) {
            ...
            return transaction.executeSql(insert_sql.index_placeholder, insert_sql.bindings, function(transaction, srs) {
              ...
              if ((typeof hook !== "undefined" && hook !== null)) {
                try {
                  ...
                  return insert_objs(hook(srs.insertId, obj_desc));
                } catch (err) {
                  //
                }
              }
      ...
      return insert_objs(obj_descs, save_hook);
    }, function(transaction, err) {
