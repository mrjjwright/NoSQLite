(function(){
  ...
  NSLCore.prototype.save = function(table, obj, after, callback) {
    var obj_desc;
  ...
  NSLCore.prototype.save_objs = function(obj_desc, callback) {
    var current_err, current_obj_desc, db, obj_descs, res, save_args, save_func, self;
    ...
    return db.transaction(function(transaction) {
      ...
      do_save = function(obj_descs1) {
        var _b, _c, _d, _e, _f, _g, _h, _i, i, insert_sql, obj, obj_desc1, objs;
        i = 0;
        _b = []; _d = obj_descs1;
        for (_c = 0, _e = _d.length; _c < _e; _c++) {
          obj_desc1 = _d[_c];
          _b.push((function() {
            objs = _.isArray(obj_desc1.obj) ? obj_desc1.obj : [obj_desc1.obj];
            _f = []; _h = objs;
            for (_g = 0, _i = _h.length; _g < _i; _g++) {
              ...
              _f.push((function() {
                ...
                return transaction.executeSql(insert_sql.index_placeholder, insert_sql.bindings, function(transaction, srs) {
                  ...
                  if ((typeof (_j = current_obj_desc.after) !== "undefined" && _j !== null)) {
                    return do_save(current_obj_desc.after(current_obj_desc, obj, srs.insertId));
                  }
                }, function(transaction, err) {
      ...
      return self.fix_save(err, current_obj_desc, callback, save_func, save_args);
    }, function(transaction) {
      // oddly browsers, don't call the method above
      // when an error occurs
      (typeof current_err !== "undefined" && current_err !== null) ? self.fix_save(current_err, current_obj_desc, callback, save_func, save_args) : null;
      if ((typeof callback !== "undefined" && callback !== null)) {
        return callback(null, res);
      }
    });
  ...
  NSLCore.prototype.fix_save = function(err, obj_desc, callback, fixback, save_args) {
