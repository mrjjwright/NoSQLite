(function(){
  ...
  NSLCore.prototype.save_objs = function(obj_desc, callback) {
    var current_err, current_obj, current_obj_desc, db, res, save_args, save_func, self, the_obj_descs;
    // we accept an array or a single obj_desc
    the_obj_descs = _.isArray(obj_desc) ? obj_desc : [obj_desc];
    self = this;
    db = this.db;
    //aggegrate_results
    res = {
    ...
    return db.transaction(function(transaction) {
      ...
      do_save = function(obj_descs) {
        var _b, _c, _d, _e, _f, _g, _h, _i, _j, i, insert_sql, j, obj, set_counters, t;
        i = 0;
        j = 0;
            ...
            for (_h = 0, _j = _i.length; _h < _j; _h++) {
              ...
              _g.push((function() {
                ...
                return transaction.executeSql(insert_sql.index_placeholder, insert_sql.bindings, function(transaction, srs) {
                  ...
                  if ((typeof current_obj === "undefined" || current_obj == undefined ? undefined : current_obj.children == undefined ? undefined : current_obj.children.length) > 0) {
                    // set the foreign key on the children
                    _l = current_obj.children;
                    ...
                    return do_save(current_obj.children);
                  }
                }, function(transaction, err) {
                  var _k, errobj;
