(function(){
  ...
  NSLCore.prototype.save_objs = function(obj_desc, callback) {
    ...
    return db.transaction(function(transaction) {
      ...
      do_save = function(obj_descs) {
        var _b, _c, _d, _e, _f, _g, _h, _i, i, insert_sql, obj, objs;
        i = 0;
        _b = []; _d = obj_descs;
  ...
  NSLCore.prototype.fixSave = function(err, obj_desc, callback, save_args) {
    ...
    if (!(typeof fix_sql !== "undefined" && fix_sql !== null)) {
      ...
      this.db.transaction(function(transaction) {
        ...
        return self.save_objs.apply(self, save_args);
      });
    }
  };
  // Built-in filters
