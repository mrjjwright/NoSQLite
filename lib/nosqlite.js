(function(){
  ...
  NoSQLite.prototype.save = function(obj_desc, callback) {
    var current_err, current_obj_desc, db, obj_descs, res, save_args, save_hook, self;
    ...
    (typeof save_hook !== "undefined" && save_hook !== null) ? this.save_hooks.push(save_hook) : null;
    self = this;
    db = this.db;
    //aggegrate_results
    res = {
    ...
    return db.transaction(function(transaction) {
      ...
      insert_objs = function(obj_descs, hooks) {
            ...
            return transaction.executeSql(insert_sql.index_placeholder, insert_sql.bindings, function(transaction, srs) {
              ...
              if ((typeof hooks !== "undefined" && hooks !== null)) {
                ...
                for (_g = 0, _i = _h.length; _g < _i; _g++) {
                  hook = _h[_g];
                  _f.push(insert_objs(hook(srs.insertId, obj_desc)));
                }
                return _f;
              }
            }, function(transaction, err) {
