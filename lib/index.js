(function(){
  ...
  NSLCore = function(db_name, options, callback) {
    ...
    self = this;
    self.db = webdb_provider.openDatabase(db_name, '1.0', 'Offline document storage', 5 * 1024 * 1024, function(err, db) {
  ...
  NSLCore.prototype.create_schema = function(obj_descs, callback) {
    var self;
    self = this;
    _.isFunction(obj_descs) ? (callback = obj_descs) : (obj_descs = _.flatten([
      obj_descs, {
        table: "last_insert",
        rowid_name: "row_id",
        objs: [
    ...
    return self.create_table(obj_descs, function(err) {
      if ((typeof err !== "undefined" && err !== null)) {
        return callback(err);
      }
      return self.execute("insert into last_insert values (0)", function(err, res) {
  ...
  NSLCore.prototype.find = function(table, predicate, the_callback) {
    ...
    return self.db.transaction(function(transaction) {
      return transaction.executeSql(sql, bindings, function(transaction, srs) {
        ...
        (typeof res === "undefined" || res == undefined ? undefined : res.length) === 1 ? (res = res[0]) : null;
    ...
    return db.transaction(function(transaction) {
      ...
      for (_c = 0, _e = _d.length; _c < _e; _c++) {
        ...
        _b.push((function() {
          ...
          obj_desc.ignore_constraint_errors === true ? (insert_options.ignore = true) : (insert_options.ignore = false);
          _g = []; _i = obj_desc.objs;
  ...
  nosqlite = {
    ...
    open: function(name, options, callback) {
      ...
      if ((typeof (_b = typeof options === "undefined" || options == undefined ? undefined : options.sync_mode) !== "undefined" && _b !== null) === true) {
        !(typeof window !== "undefined" && window !== null) ? (NSLSync = require("./sync").NSLSync) : (NSLSync = window.NSLSync);
