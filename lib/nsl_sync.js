(function(){
  var NSLCore, NSLSync, create_phantom, hash_obj, hex_sha1, pull, pull_response, push_local, send_objs_in_bucket, store_objs, sys, uuid_to_obj;
  ...
  NSLSync.prototype.save_objs = function(the_obj_desc, callback) {
    var _a, _b, _c, _d, _e, _f, nsl_obj, nsl_obj_desc, nsl_obj_descs, obj, obj_desc, obj_descs;
