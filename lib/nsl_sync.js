(function(){
  ...
  NSLSync.prototype.save_obj = function(obj_desc, callback) {
    ...
    for (_a = 0, _c = _b.length; _a < _c; _a++) {
      ...
      (function() {
        ...
        return nsl_objs_descs.push(nsl_obj_desc);
      })();
    }
    return NSLSync.__superClass__.save_obj.call(this, save_obj(nsl_obj_descs, callback));
  };
  ...
  objs_in_bucket = function(bucket, exclude_bucket, callback) {
    ...
    if ((typeof exclude_bucket !== "undefined" && exclude_bucket !== null)) {
      ...
      return self.nosqlite.query(sql, function(err, res) {
