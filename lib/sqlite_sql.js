(function(){
  ...
  SQL.prototype.insert = function(table, obj, options) {
    var _a, _b, _c, columns_sep, key, names, question_marks, sql;
    sql = "insert ";
    ...
    question_marks = [];
    names = [];
    if ((typeof (_b = typeof options === "undefined" || options == undefined ? undefined : options.rowid_sql) !== "undefined" && _b !== null)) {
