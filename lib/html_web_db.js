(function(){
  ...
  HTMLWebDB.prototype.openDatabase = function openDatabase(name, version, displayName, estimatedSize, callback) {
    throw new Error("abstract");
  };
  // Should begin an transaction
  // Any errors thrown should not terminate the transaction
  HTMLWebDB.prototype.transaction = function transaction(start, failure, success) {
    throw new Error("abstract");
  };
  ...
  HTMLWebDB.prototype.executeSQL = function executeSQL(sql, bindings, callback, errorCallback) {
    throw new Error("abstract");
  };
})();
